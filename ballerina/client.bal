...
public isolated client class Client {
    ...
    # + headers - Headers to be sent with the request 
    # + queries - Queries to be sent with the request 
    remote isolated function dataSourcesDelete(string dataSourceName, DataSourcesDeleteHeaders headers = {}, *DataSourcesDeleteQueries queries) returns http:Response|error {
        string resourcePath = string `/datasources('${getEncodedUri(dataSourceName)}')`;
        resourcePath = resourcePath + check getPathForQueryParam(queries);
        map<string|string[]> httpHeaders = http:getHeaderMap(headers);
    ...
    # + headers - Headers to be sent with the request 
    # + queries - Queries to be sent with the request 
    remote isolated function indexersDelete(string indexerName, IndexersDeleteHeaders headers = {}, *IndexersDeleteQueries queries) returns http:Response|error {
        string resourcePath = string `/indexers('${getEncodedUri(indexerName)}')`;
        resourcePath = resourcePath + check getPathForQueryParam(queries);
        map<string|string[]> httpHeaders = http:getHeaderMap(headers);
        return self.clientEp->delete(resourcePath, headers = httpHeaders);
    ...
    # + headers - Headers to be sent with the request 
    # + queries - Queries to be sent with the request 
    remote isolated function indexersReset(string indexerName, IndexersResetHeaders headers = {}, *IndexersResetQueries queries) returns http:Response|error {
    ...
    # + headers - Headers to be sent with the request 
    # + queries - Queries to be sent with the request 
    remote isolated function indexersRun(string indexerName, IndexersRunHeaders headers = {}, *IndexersRunQueries queries) returns http:Response|error {
    ...
    # + headers - Headers to be sent with the request 
    # + queries - Queries to be sent with the request 
    remote isolated function indexesDelete(string indexName, IndexesDeleteHeaders headers = {}, *IndexesDeleteQueries queries) returns http:Response|error {
        string resourcePath = string `/indexes('${getEncodedUri(indexName)}')`;
        resourcePath = resourcePath + check getPathForQueryParam(queries);
        map<string|string[]> httpHeaders = http:getHeaderMap(headers);
        return self.clientEp->delete(resourcePath, headers = httpHeaders);
    ...
    remote isolated function skillsetsDelete(string skillsetName, SkillsetsDeleteHeaders headers = {}, *SkillsetsDeleteQueries queries) returns http:Response|error {
        string resourcePath = string `/skillsets('${getEncodedUri(skillsetName)}')`;
        resourcePath = resourcePath + check getPathForQueryParam(queries);
        map<string|string[]> httpHeaders = http:getHeaderMap(headers);
        return self.clientEp->delete(resourcePath, headers = httpHeaders);
    ...
    # + headers - Headers to be sent with the request 
    # + queries - Queries to be sent with the request 
    remote isolated function synonymMapsDelete(string synonymMapName, SynonymMapsDeleteHeaders headers = {}, *SynonymMapsDeleteQueries queries) returns http:Response|error {
        string resourcePath = string `/synonymmaps('${getEncodedUri(synonymMapName)}')`;
        resourcePath = resourcePath + check getPathForQueryParam(queries);
        map<string|string[]> httpHeaders = http:getHeaderMap(headers);
        return self.clientEp->delete(resourcePath, headers = httpHeaders);
